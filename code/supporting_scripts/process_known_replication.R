...
# Gene info
wantedGenes = fread("/home/dribeiro/git/noncoding_rvat/supporting_data/wanted_genes_coding_autosomal_noMHC.txt", header = F)
coordData = fread("/home/dribeiro/git/noncoding_rvat/supporting_data/gencode_coordinates.tsv", header = F)
...
repData = fread("/home/dribeiro/burdenNC/data/known_replication/genebass_gwas_catalog_75traits.tsv.gz")
...
burdenData = fread("~/burdenNC/data/results/200k/conditional/CONTROL_conditional_SKATO_process_FDR0.05.tsv", header = T)
...
write.table(finalDT[order(n_burden_genes)],"/home/dribeiro/git/noncoding_rvat/revision/conditional_results/known_replication_CONTROL_fdr0.05.tsv", quote=F,sep="\t",row.names=F)
write.table(r,"/home/dribeiro/git/noncoding_rvat/revision/conditional_results/known_replication_CONTROL_fdr0.05.tsv.summary", quote=F,sep="\t",row.names=F, col.names=F)
