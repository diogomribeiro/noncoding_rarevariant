...
# Gene info
wantedGenes = fread("~/git/noncoding_rvat/supporting_data/wanted_genes_coding_autosomal_noMHC.txt", header = F)
coordData = fread("~/git/noncoding_rvat/supporting_data/gencode_coordinates.tsv", header = F)
...
repData = fread("~/git/noncoding_rvat/supporting_data/genebass_gwas_catalog_75traits.tsv.gz")
