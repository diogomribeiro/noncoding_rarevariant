...
png("~/git/noncoding_rvat/figures/final/example_CST3.png",1200,600)
...
ggplot() +
  ...
  geom_text(data = otherGeneData[V6 != "CST3"], aes(x = V2, label = V6), y = numTracks + midFactor*3, size = 5, color = "#969696") + 
