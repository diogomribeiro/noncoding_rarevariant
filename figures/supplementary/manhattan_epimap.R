...
png("~/git/noncoding_rvat/figures/revision/png/manhattan_epimap.png",1800,350*6)
...
# T cell
################
mergedData1 = fread("~/git/noncoding_rvat/revision/epimap/EPI_BLOOD_T_CELL_SKATO_process_all.tsv.gz")
mergedData2 = fread("~/git/noncoding_rvat/revision/epimap/conditional/EPI_BLOOD_T_CELL_SKATO_conditional_all.tsv")
...
# B cell
################
mergedData1 = fread("~/git/noncoding_rvat/revision/epimap/EPI_HSC_B_CELL_SKATO_process_all.tsv.gz")
mergedData2 = fread("~/git/noncoding_rvat/revision/epimap/conditional/EPI_HSC_B_CELL_SKATO_conditional_all.tsv")
mergedData1 = mergedData1[PVAL > 1e-9]
mergedData1$FDR = NULL
mergedData = rbind(mergedData1, mergedData2)
mergedData = merge(mergedData, geneCoordinates, by.x = "GENE", by.y = "V5")
...
# Liver
################
mergedData1 = fread("~/git/noncoding_rvat/revision/epimap/EPI_LIVER_SKATO_process_all.tsv.gz")
mergedData2 = fread("~/git/noncoding_rvat/revision/epimap/conditional/EPI_LIVER_SKATO_conditional_all.tsv")
mergedData1 = mergedData1[PVAL > 1e-9]
mergedData1$FDR = NULL
mergedData = rbind(mergedData1, mergedData2)
mergedData = merge(mergedData, geneCoordinates, by.x = "GENE", by.y = "V5")
...
# Kidney
################
mergedData1 = fread("~/git/noncoding_rvat/revision/epimap/EPI_KIDNEY_SKATO_process_all.tsv.gz")
mergedData2 = fread("~/git/noncoding_rvat/revision/epimap/conditional/EPI_KIDNEY_SKATO_conditional_all.tsv")
mergedData1 = mergedData1[PVAL > 1e-9]
mergedData1$FDR = NULL
mergedData = rbind(mergedData1, mergedData2)
mergedData = merge(mergedData, geneCoordinates, by.x = "GENE", by.y = "V5")
...
# Pancreas
################
mergedData1 = fread("~/git/noncoding_rvat/revision/epimap/EPI_PANCREAS_SKATO_process_all.tsv.gz")
mergedData2 = fread("~/git/noncoding_rvat/revision/epimap/conditional/EPI_PANCREAS_SKATO_conditional_all.tsv")
mergedData1 = mergedData1[PVAL > 1e-9]
mergedData1$FDR = NULL
mergedData = rbind(mergedData1, mergedData2)
mergedData = merge(mergedData, geneCoordinates, by.x = "GENE", by.y = "V5")
...
# Endo
################
mergedData1 = fread("~/git/noncoding_rvat/revision/epimap/EPI_ENDO_SKATO_process_all.tsv.gz")
mergedData2 = fread("~/git/noncoding_rvat/revision/epimap/conditional/EPI_ENDO_SKATO_conditional_all.tsv")
mergedData1 = mergedData1[PVAL > 1e-9]
mergedData1$FDR = NULL
mergedData = rbind(mergedData1, mergedData2)
mergedData = merge(mergedData, geneCoordinates, by.x = "GENE", by.y = "V5")
