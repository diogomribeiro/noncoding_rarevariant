...
png("~/git/noncoding_rvat/figures/revision/png/traits_plot_abc_crd_hic.png",2400,2000)

data1 = fread("~/git/noncoding_rvat/revision/no_cond_42_traits/ABC_SKATO_process_FDR0.05.tsv")
data2 = fread("~/git/noncoding_rvat/revision/no_cond_42_traits/CRD_SKATO_process_FDR0.05.tsv")
data3 = fread("~/git/noncoding_rvat/revision/no_cond_42_traits/JAVIERRE_SKATO_process_FDR0.05.tsv")

data4 = fread("~/git/noncoding_rvat/revision/no_cond_42_traits/ABC_SKATO_process_PVAL1e9.tsv")
data5 = fread("~/git/noncoding_rvat/revision/no_cond_42_traits/CRD_SKATO_process_PVAL1e9.tsv")
data6 = fread("~/git/noncoding_rvat/revision/no_cond_42_traits/JAVIERRE_SKATO_process_PVAL1e9.tsv")
